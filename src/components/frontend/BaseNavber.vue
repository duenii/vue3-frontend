 ...
 <header class="fixed w-full py-4 bg-white shadow-md">
        ...
        <nav class="container flex flex-wrap items-center px-4 mx-auto">
            ...
            <div class="hidden w-full ml-auto lg:block lg:w-auto">
                ...
                <router-link to="/about" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block"> หน่วยงาน</router-link>
                ...
                <router-link to="/register" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block"> ข่าวสาร</router-link>
